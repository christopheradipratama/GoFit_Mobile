...
class HistoryMemberAdapter(private var historys: List<BookingKelasModel>, context: Context):
    RecyclerView.Adapter<HistoryMemberAdapter.ViewHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.item_adapter_history_member, parent, false)
