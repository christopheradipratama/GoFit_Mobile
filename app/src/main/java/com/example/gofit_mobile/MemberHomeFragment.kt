...
import com.example.gofit_mobile.BookingGym.BookingGymActivity
import com.example.gofit_mobile.BookingKelas.BookingKelasActivity
import com.example.gofit_mobile.BookingKelas.CreateBookingKelasActivity
import com.example.gofit_mobile.IzinInstruktur.IzinInstrukturActivity
import com.example.gofit_mobile.api.UserApi
import com.example.gofit_mobile.databinding.FragmentHomeMemberBinding
...
//        return inflater.inflate(R.layout.fragment_home_member, container, false)
    ...
    private fun BookingGym(){
        val move = Intent(this@MemberHomeFragment.context, BookingGymActivity::class.java)
        startActivity(move)
    }

    private fun BookingKelas(){
        val move = Intent(this@MemberHomeFragment.context, BookingKelasActivity::class.java)
        startActivity(move)
    }
}