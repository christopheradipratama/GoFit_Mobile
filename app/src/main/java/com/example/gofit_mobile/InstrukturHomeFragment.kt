...
import com.example.gofit_mobile.IzinInstruktur.IzinInstrukturActivity
import com.example.gofit_mobile.JadwalHarian.JadwalHarianActivity
import com.example.gofit_mobile.Presensi.JadwalInstrukturPresensiActivity
import com.example.gofit_mobile.api.UserApi
import com.example.gofit_mobile.databinding.FragmentHomeInstrukturBinding
...
// onDestroyView.
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnPresensiMember.setOnClickListener{
            presensiMember()
        }
    }
    ...
    private fun izinInstruktur(){
        val move = Intent(this@InstrukturHomeFragment.context, IzinInstrukturActivity::class.java)
        startActivity(move)
    }

    private fun presensiMember(){
        val move = Intent(this@InstrukturHomeFragment.context, JadwalInstrukturPresensiActivity::class.java)
        startActivity(move)
    }
}