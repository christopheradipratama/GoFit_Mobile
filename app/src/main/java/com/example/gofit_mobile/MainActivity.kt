...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnJadwalHarian: Button = findViewById(R.id.btnJadwalHarian)
        ...
        binding.btnForgetPassword.setOnClickListener(View.OnClickListener{
            val move = Intent(this@MainActivity, ForgetPasswordActivity::class.java)
            startActivity((move))
        })

        binding.btnJadwalHarian.setOnClickListener(View.OnClickListener{
            val move = Intent(this@MainActivity, JadwalHarianActivity::class.java)
            startActivity((move))
        })
    }
}